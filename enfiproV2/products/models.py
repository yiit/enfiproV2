...
class Product(models.Model):
    ...
    urun_mesaj1      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj2      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj3      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj4      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj5      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj6      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj7      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj8      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_mesaj9      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_tanim       = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_icerik      = models.TextField(max_length=256, default="Tanımsız", blank=True)
    urun_aciklama    = models.TextField(max_length=256, default="Tanımsız", blank=True)
