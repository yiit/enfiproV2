...
class PrintLog(models.Model):
    weight = models.CharField(max_length=50)  # Yazdırılan ağırlık bilgisi
    file_path = models.CharField(max_length=255)  # Yazdırılan dosyanın yolu
    timestamp = models.DateTimeField(auto_now_add=True)  # Yazdırma tarihi ve saati

    def __str__(self):
        return f"{self.weight} - {self.timestamp}"